...
import SimpleCard from "../projectDinamicDispatch/simpleCard.js";
import PercentCard from "../projectDinamicDispatch/percentCard.js";
import make from "../projectDinamicDispatch/solution.js";
...
describe("CardGame", () => {
  ...
  it("#flow 2", () => {
    ...
    expect(cdr(step3))
      .toBe(`Игрок 'Ada' применил 'Покрытый царапинами клык демона коряги'
